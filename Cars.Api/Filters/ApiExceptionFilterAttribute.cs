...
using Cars.Application.Exceptions;

namespace Cars.Api.Filters;
...
public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
{
    ...
    private void HandleFluentValidationException(ExceptionContext context)
    {
        ...
        var failures = exception.Errors.GroupBy(e => e.PropertyName, e => e.ErrorMessage).ToDictionary(x => x.Key, x => x.ToArray());
